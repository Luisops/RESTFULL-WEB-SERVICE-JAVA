...
public class RestCronograma {
	 ...
	 public String postCronograma(@RequestBody Cronograma crono) throws InterruptedException, ExecutionException{ 
		 return firebaseServices.saveCronogramaDetails(crono); }
